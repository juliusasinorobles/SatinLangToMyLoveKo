            ...
            <div class="large-6 columns">
              <label><strong>Profile Image</strong>
                <div class="profile-pic" style="margin: auto; margin-bottom: 20px;">
                    <img src="resources/images/default-profile-pic.jpg" />
                    <div class="change-trigger"><strong>Change</strong></div>
                </div>
              </label>
              </div>
            <div class="large-6 columns">
              <label><strong>About yourself:</strong>
                <textarea name="message" placeholder="" maxlength="255" style="height: 250px; resize:none;">{about}</textarea>
              </label>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="large-6 columns">
              <label><strong>Birthdate</strong>
                <input type="text" value="{birthdate}" id="dp1">
              </label>
            </div>
          </div>
          <div class="row">
            <div class="large-4 columns">
               <input type="submit" name="submit" value="Save" class="button [tiny small large] submit-button" />
